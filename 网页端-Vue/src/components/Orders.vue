    ...
    <div class="book_table">
        ...
        <div v-else>
            ...
            >
                ...
                <el-table-column prop="price" label="总价" width="250">
    ...
    export default {
        ...
        methods: {
            gen() {
                ...
                this.during = '';
                this.searchType = 0;
                let url = 'http://localhost:8181/order/getByID?id=' + sessionStorage.getItem('id');
            ...
            dateSearch() {
                ...
                let url = 'http://localhost:8181/order/duringByUser?'

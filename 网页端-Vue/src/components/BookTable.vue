<template>
    <div class="book_table">
        <div style="height: 40px; margin-left:400px; width: 400px;">
        ...
        >
            ...
            <el-table-column label="操作">
                <template slot-scope="scope">
                    <el-button
                            type="success" size="mini" icon="el-icon-shopping-cart-2"
                            @click="cart(scope.row)"></el-button>
                    <el-button
                            type="primary" size="mini" icon="el-icon-sell"
                            @click="buy(scope.row)"></el-button>
                </template>
            </el-table-column>
        </el-table>
        <el-pagination

    ...
    <div class="updateBook">
        ...
        <div class="form">
            <el-form :rules="rules" :model="bookForm" @keyup.native.enter="update">
                ...
                <el-form-item prop="description" label="图书介绍">
    ...
    export default {
        ...
        methods: {
            update() {
                ...
                let url = 'http://localhost:8181/book/updateBook';

                axios.put(url, this.bookForm).then((response) =>{
                    if (response.data === "success"){
                        this.$message.success('修改成功');
                        this.$router.push('/adminBookTable');
                    }
                    else {
                        this.$message.error('修改失败，ISBN与已有图书重复！');
                    }
                });
            },
            reset() {
        ...
        created() {
            ...
            let url = 'http://localhost:8181/book/getByID?id=' + id;
